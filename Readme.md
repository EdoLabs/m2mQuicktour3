...
4. [Quick Tour](#quick-tour)
   * [Capturing and Watching Data from Remote Device](#capturing-and-watching-data-from-remote-device)
   * [Raspberry Pi Remote Control](#raspberry-pi-remote-control)
   * [Capturing Data from Remote C/C++ Application through IPC (inter-process communication)](#capturing-data-from-remote-c/c++-application-through-IPC)
