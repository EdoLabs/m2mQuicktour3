...
4. [Quick Tour](#quick-tour)
   ...
   3. [Capturing Data from Remote C/C++ Application through IPC (inter-process communication)](#capturing-data-from-remote-c++-application-through-IPC)
...
### Capturing Data from Remote C++ Application through IPC
